                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <div className="space-y-1.5" data-testid="services-accordion">
                              ...
                              {isOpen && (
                                <div className="border-t" style={{ borderColor: 'var(--border-subtle)' }}>
                                  ...
                                  {cat.includes('abbonament') && cardTemplates.length > 0 && (
                                    <div className="border-t p-3" style={{ borderColor: 'rgba(168,85,247,0.2)', background: 'rgba(168,85,247,0.04)' }} data-testid="card-templates-in-abbonamento">
                        ...
                        {/* Le card sono dentro la sezione Abbonamento */}
                      </div>
                    </>
                  )}
