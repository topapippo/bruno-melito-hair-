...
import { Share2, Wand2, Image, Settings, History, ChevronDown, ChevronUp, CheckCircle, Loader2, Upload, X, Eye, FileText, Send } from 'lucide-react';
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <h3 className="font-semibold text-gray-700 flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-gray-400 font-normal">(opzionale — se presente pubblica anche su Instagram)</span>
        </h3>
        {imagePreview ? (
    ...
    <div className="space-y-5">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
        <h3 className="font-semibold text-gray-700 flex items-center gap-2">
          <Settings className="w-4 h-4 text-gray-500" /> Webhook Make.com
        </h3>
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">Copia l'URL dal modulo Webhook in Make.com e incollalo qui</p>
        </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl overflow-hidden">
        <button onClick={() => setShowGuide(g => !g)}
          ...
          <span>📖 Come configurare Make.com (5 minuti)</span>
        ...
        {showGuide && (
          <div className="px-5 pb-5 text-xs text-amber-900 space-y-2">
            ...
            <p><strong>3.</strong> Aggiungi modulo <strong>"Facebook Pages → Create a Post"</strong> → collegati con il tuo account FB</p>
            <p><strong>4.</strong> Aggiungi modulo <strong>"Instagram for Business → Create a Photo"</strong> → collegati con IG</p>
            <p><strong>5.</strong> Mappa i campi: <code className="bg-amber-100 px-1 rounded">text</code> → messaggio, <code className="bg-amber-100 px-1 rounded">image_url</code> → foto</p>
            <p><strong>6.</strong> Attiva lo scenario → incolla l'URL qui sopra → Salva</p>
            <p className="mt-2 text-amber-700 font-medium">💡 Ti preparo il blueprint da importare — dimmi quando sei su Make.com</p>
          </div>
        )}
      </div>
    </div>
